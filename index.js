...
// Based on USB HID Usage Tables (Usage Page 0x07)
// and UEFI EDK2 UefiInternalFormRepresentation.h
// ============================================
    ...
    rows: [
        ...
        // Number row
        {
            sections: [
                ...
                [
                    { hid: 0x53, label: 'Num', size: '1' },
                    { hid: 0x54, label: '/', size: '1' },
                    { hid: 0x55, label: '*', size: '1' },
                    { hid: 0x56, label: '-', size: '1' },
                ],
            ]
        },
        // QWERTY row
        {
            sections: [
                ...
                [
                    { hid: 0x5F, label: '7', size: '1' },
                    { hid: 0x60, label: '8', size: '1' },
                    { hid: 0x61, label: '9', size: '1' },
                    { hid: 0x57, label: '+', size: '1', tall: true },
                ],
            ]
        },
        // Home row
        {
            sections: [
                ...
                [{ spacer: true, size: '3' }],
                [
                    { hid: 0x5C, label: '4', size: '1' },
                    { hid: 0x5D, label: '5', size: '1' },
                    { hid: 0x5E, label: '6', size: '1' },
                    { spacer: true, size: '1' },
                ],
            ]
        },
        // Bottom row
        {
            sections: [
                ...
                [
                    { hid: 0x59, label: '1', size: '1' },
                    { hid: 0x5A, label: '2', size: '1' },
                    { hid: 0x5B, label: '3', size: '1' },
                    { hid: 0x58, label: 'Ent', size: '1', tall: true },
                ],
            ]
        },
        // Space row
        {
            sections: [
                ...
                [
                    { hid: 0x62, label: '0', size: '2' },
                    { hid: 0x63, label: '.', size: '1' },
                    { spacer: true, size: '1' },
                ],
            ]
        },
        ...
        // Bottom row
        {
            sections: [
                [
                    ...
                    { hid: 0x64, label: '\\', size: '1' }, // ISO extra key
                    { hid: 0x1D, label: 'Z', size: '1' },
                    { hid: 0x1B, label: 'X', size: '1' },
                    { hid: 0x06, label: 'C', size: '1' },
                    { hid: 0x19, label: 'V', size: '1' },
        ...
        // Space row
        {
            sections: [
                [
                    ...
                    { hid: 0xE2, label: 'Alt', size: '1-25', modifier: true },
                    { hid: 0x2C, label: 'Space', size: '6-25' },
                    { hid: 0xE6, label: 'AltGr', size: '1-25', modifier: true },
                    { hid: 0xE7, label: 'Win', size: '1-25', modifier: true },
                    { hid: 0x65, label: 'Menu', size: '1-25', modifier: true },
                    { hid: 0xE4, label: 'Ctrl', size: '1-25', modifier: true },
                ],
...
const LAYOUT_JIS = {
    ...
    rows: [
        ...
        // Bottom row (with extra JIS keys)
        {
            sections: [
                [
                    { hid: 0xE1, label: 'Shift', size: '2-25', modifier: true },
...
function createKey(keyData) {
    ...
    // Handle tall keys (numpad + and enter)
    if (keyData.tall) {
        key.classList.add('key-numpad-plus');
    }
